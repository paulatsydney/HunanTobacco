...
GLOBAL.labels.set({
  ...
  menu: {
    ...
    start: { en:"Start", fr:"Démarrer" },
    restart: { en:"Restart", fr:"Redémarrer" },
    stopRestart: { en:"Shutdown / restart", fr:"Arrêter / redémarrer" },
    main: { en:"Main Menu", fr:"Menu principal" },
    test: { en:"Test Menu", fr:"Menu test" },
    reportIncident: { en:"Report an incident", fr:"Soumettre un incident", de:"Report an incident" },
    recordTraces: { en:"Record traces", fr:"Enregistrer des traces", de:"Record traces" }
  },
  aboutPopup: {
    title: { en:"About...", fr:"A propos..." },
    projectLabel: { en:"Project", fr:"Projet" },
    projectVersion: { en:"Project version", fr:"Version projet" },
    productVersion: { en:"Interactive version", fr:"Version Interactive" },
    studioVersion: { en:"Studio version", fr:"Version Studio", de:"Studio version" },
    galaxyVersion: { en:"Galaxy version", fr:"Version Galaxy", de:"Galaxy version" },
    galaxyURL: { en:"Galaxy URL", fr:"URL Galaxy", de:"Galaxy URL" },
    licenceName: { en:"Licence name", fr:"Nom licence", de:"Licence name" },
    licenceId: { en:"Licence id", fr:"Ident. licence", de:"Licence id" },
    machine: { en:"Machine", fr:"Machine", de:"Machine" },
    user: { en:"User", fr:"Utilisateur", de:"User" },
    date: { en:"Date", fr:"Date", de:"Date" },
    serialNumber: { en:"Serial number", fr:"Numéro de série", de:"Serial number" },
    environment: { en:"Environment", fr:"Environnement", de:"Environment" },
    frameworkVersion: { en:"SDK version", fr:"Version SDK" }
  },
  popup: {
    defaultTitle: { en:"Desktop Agent", fr:"Desktop Agent", de:"Desktop Agent" },
    autoStartLogon: { en:"Auto start at session logon", fr:"Lancement à l'ouverture de session", de:"Auto start at session logon" },
    launchConfirmation: { en:"Ask confirmation before starting", fr:"Demander confirmation avant lancement", de:"Ask confirmation before starting project" }
  }
//  stopPopup: {
//    title: { en:"Agent shutdown", fr:"Arrêt Agent" },
//    label: {
//      en:"Are you sure you want to stop Agent ?",
//      fr:"Etes-vous certain de quitter Agent ?"}
//  },
//  restartPopup: {
//    title: { en:"Agent restart", fr:"Redémarrage Agent" },
//    label: {
//      en:"Do you want to restart now ?",
//      fr:"Voulez-vous redémarrer maintenant ?"}
//  },
//  updatePopup: {
//    title: { en:"Agent update", fr:"Mise à jour Agent" },
//    label: {
...
ctx.popup.bootstrap.meta.accordionItem = {
  name: 'accordion item',
  description: 'accordion item',    /// Utilisé ?
  type: 'object',
  group: '3 - Child items',
  value: null
};
...
ctx.popup.bootstrap.meta.navbarMenu = {
  name: 'navbar item',
  description: 'navbar item',   /// Utilisé ?
  type: 'object',
  group: '3 - Child items',
  value: null
};
...
ctx.popup.bootstrap.meta.wizardItem = {
  name: 'wizard item',
  description: 'wizard item',   /// Utilisé ?
  type: 'object',
  group: '3 - Child items',
  value: null
};
