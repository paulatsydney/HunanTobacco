...
GLOBAL.labels.set({
  diagnostic: {
    ...
    saveTooltip: {
      en:"Click to save desktop and Agent diagnostics",
      fr:"Cliquer pour enregistrer le diagnostique du poste et de Contextor",
      de:"Click to save desktop and Agent diagnostics" },
    archiveReady: {
    ...
    checkBHOSuccess: {
      en:"I.E. Web connector is enabled",
      fr:"Le connecteur Web I.E. est activé",
      de:"I.E. Web connector is enabled" },
    checkBHOFail: {
      en:"I.E. Web connector is disabled",
      fr:"Le connecteur Web I.E. est désactivé",
      de:"I.E. Web connector is disabled" }
  }
});
...
GLOBAL.events.START.on(function(ev) {
  ...
  ctx.addPendingFunction(function () {
    ...
    if (ctx.options.trace.recording) ctx.log('Recording is enabled');
